    ...
    return (
        <aside className="w-1/5 bg-white shadow-md h-screen">
            ...
            <nav className="mt-6">
                ...
                <a href="/protected/students/" className={`block py-2.5 px-4 rounded transition ${page.pageSelected === "1" ? 'duration-200 bg-gray-200 text-gray-900 font-bold' : 'duration-750 hover:bg-gray-200 hover:text-gray-900'} `}>
                    Students
                </a>
