    ...
    return (
        <aside className="w-1/5 bg-white shadow-md h-screen">
            ...
            <nav className="mt-6">
                ...
                {showStudentOptions && (
                    <div className="ml-4">
                        <a href="/protected/students/notes" className="block py-2.5 px-4 rounded transition duration-750 hover:bg-gray-200 hover:text-gray-900">
                            Notes
                        </a>
                        <a href="/protected/students/behaviour" className="block py-2.5 px-4 rounded transition duration-750 hover:bg-gray-200 hover:text-gray-900">
                            Behaviour
                        </a>
                        <a href="/protected/students/positives" className="block py-2.5 px-4 rounded transition duration-750 hover:bg-gray-200 hover:text-gray-900">
                            Positives
                        </a>
                    </div>
                )}
